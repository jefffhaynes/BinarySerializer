...
namespace BinarySerialization.Test.Subtype
{
        public class SubtypeTests : TestBase
    {
        ...
        public void NonUniqueSubtypeValuesTest()
        {
            ...
            var exception = Record.Exception(() => Roundtrip(expected));
       ...
       // [ExpectedException(typeof (InvalidOperationException))]
        ...
        {
            var exception = Record.Exception(() => Roundtrip(new ThrowOnAbstractTypeWithNoSubtypeClass{Superclass = new SubclassA()}));
            Assert.NotNull(exception);
            Assert.IsType<InvalidOperationException>(exception);
        }
